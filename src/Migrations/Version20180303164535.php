 ...
 */
class Version20180303164535 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE location CHANGE created created DATE DEFAULT \'NULL\', CHANGE updated updated DATE DEFAULT \'NULL\', CHANGE latitude latitude NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE longitude longitude NUMERIC(10, 0) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE timeout_location CHANGE description description VARCHAR(200) NOT NULL COLLATE utf8_unicode_ci, CHANGE address address VARCHAR(200) NOT NULL COLLATE utf8_unicode_ci, CHANGE category category VARCHAR(200) NOT NULL COLLATE utf8_unicode_ci, CHANGE link link VARCHAR(200) NOT NULL COLLATE utf8_unicode_ci, CHANGE rating rating DOUBLE PRECISION NOT NULL, CHANGE price price VARCHAR(20) NOT NULL COLLATE utf8_unicode_ci, CHANGE image image VARCHAR(200) NOT NULL COLLATE utf8_unicode_ci, CHANGE image_dynamic image_dynamic VARCHAR(200) NOT NULL COLLATE utf8_unicode_ci, CHANGE featured featured TINYINT(1) NOT NULL, CHANGE start_date start_date DATE NOT NULL, CHANGE end_date end_date DATE NOT NULL');
