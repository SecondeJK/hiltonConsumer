 ...
 */
class Version20180303163933 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE feed (id INT AUTO_INCREMENT NOT NULL, location_name VARCHAR(100) NOT NULL, location_api_string VARCHAR(200) NOT NULL, provider VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE timeout_location (id INT NOT NULL, description VARCHAR(200) NOT NULL, address VARCHAR(200) NOT NULL, category VARCHAR(200) NOT NULL, link VARCHAR(200) NOT NULL, rating DOUBLE PRECISION NOT NULL, price VARCHAR(20) NOT NULL, image VARCHAR(200) NOT NULL, image_dynamic VARCHAR(200) NOT NULL, featured TINYINT(1) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
